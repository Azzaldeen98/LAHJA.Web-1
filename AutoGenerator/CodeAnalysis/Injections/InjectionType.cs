...
{
    /// <summary>
    /// Defines the types of code injection that can be performed.
    /// </summary>
    public enum InjectionType
    {
        /// <summary>
        /// Injects an interface implementation into the target class.
        /// </summary>
        Interface,

        /// <summary>
        /// Injects a property into the target class.
        /// </summary>
        Property,

        /// <summary>
        /// Injects a method into the target class.
        /// </summary>
        Method,

        /// <summary>
        /// Placeholder for potential future injection types.
        /// </summary>
