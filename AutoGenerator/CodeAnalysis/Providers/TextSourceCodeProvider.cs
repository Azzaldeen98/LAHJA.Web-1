...
{
    /// <summary>
    /// Provides source code from an in-memory text string and optionally allows saving it to a file.
    ...
    public class TextSourceCodeProvider : ISourceCodeProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextSourceCodeProvider"/> class with the given source code.
        /// </summary>
        /// <param name="code">The source code text to provide.</param>
        /// <param name="outputPath">Optional output path to save the source code later.</param>
        /// <exception cref="ArgumentNullException">Thrown if the source code is null.</exception>
        ...
        /// </summary>
        /// <returns>A task that returns the source code string.</returns>
        public Task<string> GetSourceCodeAsync() => Task.FromResult(_code);

        /// <summary>
        /// Saves the source code to the specified file path.
        /// </summary>
        /// <param name="code">The source code to save.</param>
        /// <param name="outputPath">Optional path to save the code. If not provided, the constructor-provided path is used.</param>
