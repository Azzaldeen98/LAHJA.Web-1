...
{
    /// <summary>
    /// Provides an abstraction for loading and saving source code, either from a file or in-memory text.
    /// </summary>
    public interface ISourceCodeProvider
    {
        Task<string> GetSourceCodeAsync();
        Task SaveSourceCodeAsync(string code, string? outputPath = null);
    }
