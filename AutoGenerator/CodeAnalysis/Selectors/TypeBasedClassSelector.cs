...
{
    /// <summary>
    /// Selects classes from a syntax tree based on a predefined set of type names.
    /// </summary>
    public class TypeBasedClassSelector : IClassSelector
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeBasedClassSelector"/> class.
        /// </summary>
        /// <param name="types">A collection of <see cref="Type"/> objects whose class names will be used for selection.</param>
        /// <exception cref="ArgumentNullException">Thrown if the <paramref name="types"/> argument is null.</exception>
        ...
        /// whose names match the provided type names.
        /// </summary>
        /// <param name="root">The root of the syntax tree to search within.</param>
        /// <returns>
        /// An enumerable of <see cref="ClassDeclarationSyntax"/> objects
        /// with class names matching those in the type list.
        /// </returns>
